...
" move line(s)
" under normal mode use Ctrl+Shift+j/k
" under visual mode first select lines and then use Ctrl+Shift+j/k
...
"  < 界面配置 >
" -----------------------------------------------------------------------------
set guifont=DejaVu\ Sans\ Mono:h10                    "设置字体:字号（字体名称空格用\转义）
" you can choose: 'DejaVu\ Sans\ Mono', 'Ubuntu\ Mono', 'YaHei\ Consolas\ Hybrid'
set number                                            "显示行号
